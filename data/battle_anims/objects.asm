...
; ANIM_OBJ_MOONBLAST
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_B9, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_YELLOW, ANIM_GFX_CHARGE
; ANIM_OBJ_MOON
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_84, BATTLEANIMFUNC_MOON, PAL_BATTLE_OB_GRAY, ANIM_GFX_GLOBE
