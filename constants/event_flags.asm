...
; Johto story events
	...
	const_skip ; unused in pokegscrystal
...
; New to Crystal
	...
	const EVENT_SAW_SUICUNE_AT_VERMILION_CITY
	...
	const EVENT_ROUTE_25_EUSINE
	const EVENT_ROUTE_25_EUSINE_MOVED_OUT_OF_WAY
	const EVENT_FOUGHT_SUICUNE_ON_ROUTE_25
